...
import JorgeWordCount from '../lib/jorge-word-count';
  ...
  describe('when the jorge-word-count:toggle event is triggered', () => {
    it('hides and shows the modal panel', () => {
      ...
      runs(() => {
        ...
        let jorgeWordCountElement = workspaceElement.querySelector('.jorge-word-count');
        expect(jorgeWordCountElement).toExist();

        let jorgeWordCountPanel = atom.workspace.panelForItem(jorgeWordCountElement);
